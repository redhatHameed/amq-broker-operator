...
func (in *AMQPodNames) DeepCopyInto(out *AMQPodNames) {
	*out = *in
	if in.PodName != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AMQPodNames.
func (in *AMQPodNames) DeepCopy() *AMQPodNames {
	if in == nil {
		return nil
	}
	out := new(AMQPodNames)
...
func (in *ActiveMQArtemisStatus) DeepCopyInto(out *ActiveMQArtemisStatus) {
	*out = *in
	in.PodNames.DeepCopyInto(&out.PodNames)
	return
}
